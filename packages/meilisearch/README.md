...
generic, or a union of literals with one valid member, is
...
- **A uid typed `string`, generic, or a union with one valid member is checked at run time only.** The types refuse a
