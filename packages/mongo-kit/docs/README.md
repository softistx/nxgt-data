...
| [Files](guide/files.md) | files have to be stored beside the documents — GridFS buckets on the kit, written in its transactions, and their indexes created by `syncBuckets()` |
